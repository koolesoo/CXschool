...
const popupTexts = [
  ...
  "В КПЭ не включены показатели CX.\n\nНе хватает до максимума (10 баллов по чек-листу): включить CX-метрики в КПЭ сотрудников так, чтобы они существенно влияли на премию.",
